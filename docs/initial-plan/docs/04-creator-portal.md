...
4. Translates each segment into English
5. Marks clip as **Ready for Review**
...
Rules:
- changes update dependent layers (translations, groups)
- destructive changes trigger translation refresh
