...
- **Processing Pipeline** (Workers + Queues) for ASR, segmentation, and segment-level English translation
...
- Segment shaping + segment-level English translation
- No auto-retry
...
5. Segment shaping + English translation
...
- Add a dedicated translation provider or translation memory layer
